...
-- Copiando dados para a tabela scfr_database.users: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `name`, `email`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Administrador', 'admin@admin.com', '$2y$10$LqNhxuwYFj62zE4C4kSn4.qKHHrhZxryj5Z.fPYIEJdUbvpi8H.Ei', NULL, '2017-01-05 17:27:12', '2017-01-05 17:27:12');
